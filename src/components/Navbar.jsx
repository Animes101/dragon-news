    ...
    <div className="flex items-center justify-between gap-16">
        <ul className="flex items-center justify-between gap-10">
            <li className="text-base group flex  cursor-pointer flex-col">
                <NavLink>Home </NavLink><span className="mt-[2px] h-[3px] w-[0px] rounded-full bg-sky-500 transition-all duration-300 group-hover:w-full"></span>
            </li>
            <li className="text-base group flex  cursor-pointer flex-col">
            <NavLink>About </NavLink> <span className="mt-[2px] h-[3px]  w-[0px] rounded-full bg-sky-500 transition-all duration-300 group-hover:w-full"></span>
            </li>
            <li className="text-base group flex  cursor-pointer flex-col">
            <NavLink>Career</NavLink> <span className="mt-[2px] h-[3px]  w-[0px] rounded-full bg-sky-500 transition-all duration-300 group-hover:w-full"></span>
            </li>
        </ul>
